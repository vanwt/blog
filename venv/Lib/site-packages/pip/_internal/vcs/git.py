...
class Git(VersionControl):
    ...
    def get_revision_sha(self, dest, rev):
        """
        Return (sha_or_none, is_branch), where sha_or_none is a comment hash
    ...
    def resolve_revision(self, dest, url, rev_options):
        ...
        # the form of a Git comment hash.
    ...
    def is_commit_id_equal(self, dest, name):
        """
        Return whether the current comment hash equals the given name.
    ...
    def fetch_new(self, dest, url, rev_options):
        ...
        if rev_options.rev:
            ...
            if branch_name is None:
                # Only do a checkout if the current comment id doesn't match
